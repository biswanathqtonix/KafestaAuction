            ...
            <div className="l-theme animated-css animsition" data-header="sticky" data-header-top={200}>
                ...
                <div className="section-title-page area-bg area-bg_dark area-bg_op_60">
                    ...
                    <div className="container">
                        ...
                        <div className="col offset-lg-3">
                            ...
                            <h1 className="b-title-page">About Us</h1>
                ...
                <footer className="footer">
                    ...
                    <div className="row">
                        <div className="col-12">
                        <div className="text-center">
                            <div className="footer-logo"><a className="footer-logo__link" href="home.html"><img className="img-responsive" src="assets/media/general/logo-light.png" alt="Logo" /></a></div>
